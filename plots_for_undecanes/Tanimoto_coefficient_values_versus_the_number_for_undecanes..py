...
# Plotting
ax = plt.subplot(111)
plt.plot(number, ordered_Topological_indices_undecanes, linestyle='-', label="Based on topological indices") 
plt.plot(number, ordered_atom_pair_undecanes, linestyle='--', label="Based on atom pair")
plt.plot(number, ordered_topological_torsion_undecanes, linestyle='-.', label="Based on topological torsion") 
plt.plot(number, ordered_Avalon_undecanes, linestyle=':', label="Based on Avalon") 
plt.plot(number, ordered_MACCS_keys_undecanes, linestyle='-', linewidth=0.5, label="Based on MACCS keys") 
plt.plot(number, ordered_Morgan_circular_undecanes, linestyle='-', linewidth=2, label="Based on Morgan circular") 
