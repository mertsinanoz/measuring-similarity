...
# Plotting
ax = plt.subplot(111)
plt.plot(sorted_Topological_indices_undecanes,sorted_atom_pair_undecanes, label="Topological indices vs atom pair ")
plt.plot(sorted_Topological_indices_undecanes,sorted_topological_torsion_undecanes, label="Topological indices vs topological torsion")
plt.plot(sorted_Topological_indices_undecanes,sorted_Avalon_undecanes, label="Topological indices vs Avalon")
plt.plot(sorted_Topological_indices_undecanes,sorted_MACCS_keys_undecanes, label="Topological indices vs MACCS keys")
plt.plot(sorted_Topological_indices_undecanes,sorted_Morgan_circular_undecanes, label="Topological indices vs Morgan circular")
