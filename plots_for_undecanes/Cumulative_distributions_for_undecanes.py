# -*- coding: utf-8 -*-
"""
Created on Tue Feb 18 11:08:59 2025
...
df1=pd.read_excel('adjacency_matrix_undecanes.xlsx')
df2=pd.read_excel('atom_pair_undecanes.xlsx')
df3=pd.read_excel('topological_torsion_undecanes.xlsx')
df4=pd.read_excel('Avalon_undecanes.xlsx')
df5=pd.read_excel('MACCS_keys_undecanes.xlsx')
df6=pd.read_excel('Morgan_circular_undecanes.xlsx')


#Cumulative distributions of the Tanimoto coefficients based on 
#the molecular fingerprints and adjacency matrices of undecanes.
...
# Plotting
ax = plt.subplot(111)
plt.plot(sorted_data1,cdf1,label="Based on adjacency matrix")
