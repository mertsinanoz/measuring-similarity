...
# Plotting
ax = plt.subplot(111)
plt.plot(sorted_Topological_indices_dodecanes,sorted_atom_pair_dodecanes, label="Topological indices vs atom pair ")
plt.plot(sorted_Topological_indices_dodecanes,sorted_topological_torsion_dodecanes, label="Topological indices vs topological torsion")
plt.plot(sorted_Topological_indices_dodecanes,sorted_Avalon_dodecanes, label="Topological indices vs Avalon")
plt.plot(sorted_Topological_indices_dodecanes,sorted_MACCS_keys_dodecanes, label="Topological indices vs MACCS keys")
plt.plot(sorted_Topological_indices_dodecanes,sorted_Morgan_circular_dodecanes, label="Topological indices vs Morgan circular")
