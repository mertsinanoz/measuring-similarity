# -*- coding: utf-8 -*-
"""
Created on Thu Jun  5 23:05:10 2025
...
df1=pd.read_excel('topological_indices_cyclodecanes.xlsx')
df2=pd.read_excel('atom_pair_cyclodecanes.xlsx')
df3=pd.read_excel('topological_torsion_cyclodecanes.xlsx')
df4=pd.read_excel('Avalon_cyclodecanes.xlsx')
df5=pd.read_excel('MACCS_keys_cyclodecanes.xlsx')
df6=pd.read_excel('Morgan_circular_cyclodecanes.xlsx')
