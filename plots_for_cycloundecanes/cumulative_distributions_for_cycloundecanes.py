# -*- coding: utf-8 -*-
"""
Created on Mon Jun  9 21:35:49 2025
...
df1=pd.read_excel('topological_indices_cycloundecanes.xlsx')
df2=pd.read_excel('atom_pair_cycloundecanes.xlsx')
df3=pd.read_excel('topological_torsion_cycloundecanes.xlsx')
df4=pd.read_excel('Avalon_cycloundecanes.xlsx')
df5=pd.read_excel('MACCS_keys_cycloundecanes.xlsx')
df6=pd.read_excel('Morgan_circular_cycloundecanes.xlsx')

#Cumulative distributions of the Tanimoto coefficients based on 
#the molecular fingerprints and adjacency matrices of cycloundecanes.
