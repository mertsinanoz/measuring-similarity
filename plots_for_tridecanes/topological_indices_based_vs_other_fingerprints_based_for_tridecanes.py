...
# Plotting
ax = plt.subplot(111)
plt.plot(sorted_Topological_indices_tridecanes,sorted_atom_pair_tridecanes, linestyle='-', label="Topological indices vs atom pair ")
plt.plot(sorted_Topological_indices_tridecanes,sorted_topological_torsion_tridecanes, linestyle='--', label="Topological indices vs topological torsion")
plt.plot(sorted_Topological_indices_tridecanes,sorted_Avalon_tridecanes, linestyle='-.', label="Topological indices vs Avalon")
plt.plot(sorted_Topological_indices_tridecanes,sorted_MACCS_keys_tridecanes, linestyle=':', label="Topological indices vs MACCS keys")
plt.plot(sorted_Topological_indices_tridecanes,sorted_Morgan_circular_tridecanes, linestyle='-', linewidth=2, label="Topological indices vs Morgan circular")
