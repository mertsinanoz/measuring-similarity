...
# Plotting
ax = plt.subplot(111)
plt.plot(number, ordered_Topological_indices_tridecanes, linestyle='-', label="Based on topological indices") 
plt.plot(number, ordered_atom_pair_tridecanes, linestyle='--', label="Based on atom pair")
plt.plot(number, ordered_topological_torsion_tridecanes, linestyle='-.', label="Based on topological torsion") 
plt.plot(number, ordered_Avalon_tridecanes, linestyle=':', label="Based on Avalon") 
plt.plot(number, ordered_MACCS_keys_tridecanes, linestyle='-', linewidth=0.5, label="Based on MACCS keys") 
plt.plot(number, ordered_Morgan_circular_tridecanes, linestyle='-', linewidth=2, label="Based on Morgan circular") 
